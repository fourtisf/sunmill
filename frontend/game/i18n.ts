...
const EN: Dict = {
  ...
  'intro.blurb': 'A production-chain farm on Robinhood Chain. Grow crops, feed animals, run the machines, fill the truck.',
  ...
  'login.noAccount': '{wallet} has no Ethereum account. Pick another wallet, or add one there first.',
...
const ID: Dict = {
  ...
  'intro.blurb': 'Peternakan rantai produksi di Robinhood Chain. Tanam, beri makan hewan, jalankan mesin, isi truk.',
  ...
  'login.noAccount': '{wallet} tidak punya akun Ethereum. Pilih dompet lain, atau buat akunnya dulu di sana.',
